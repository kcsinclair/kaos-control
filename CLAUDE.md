...
Required fields on every artifact: `title`, `type`, `status`, `lineage`. Type vocabulary (§4.2 of spec): `idea`, `plan-backend`, `plan-frontend`, `plan-dev`, `plan-test`, `test`, `prototype`, `release`, `sprint`, `defect`. Status vocabulary: `draft`, `clarifying`, `planning`, `in-development`, `in-qa`, `approved`, `rejected`, `abandoned`, `done`, `blocked`. The canonical list lives in `KnownStatuses` at [internal/artifact/artifact.go](internal/artifact/artifact.go) — verify there if in doubt.
