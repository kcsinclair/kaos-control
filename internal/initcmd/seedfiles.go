...
var seedFileSpecs = []seedFileSpec{
	...
	// CLAUDE.md is no longer a static seed — the AGENTS.md-primary directive
	// set (AGENTS.md canonical + CLAUDE.md/GEMINI.md pointers) is generated by
	// directives.Generate in ScaffoldProject.
	{
