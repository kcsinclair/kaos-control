...
- Name: 10-artefact-run-count-column.spec.ts >> Flow 10 — Artefact run count column >> TC3: "Agent Running" pill appears while run is active and disappears on completion
- Location: flows/10-artefact-run-count-column.spec.ts:182:3
