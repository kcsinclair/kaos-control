...
- navigation "Project navigation":
  ...
  - status "Git repository status": main clean 8d8e2f5 Initial fixture commit
  - text: kaos-control 0.1.2
  - button "Collapse sidebar" [expanded]
- main:
  - navigation "Artifact path":
    - button "artifacts"
    - text: / lifecycle / requirements / smoke-req-01.md
  - button "Run Agent"
  - button "Edit"
  - heading "Smoke Requirement Alpha" [level=1]
  - heading "Smoke Requirement Alpha" [level=1]
  - paragraph: A smoke test fixture requirement in draft status.
  - heading "Goals" [level=2]
  - paragraph: Test the edit-save flow.
  - heading "Acceptance Criteria" [level=2]
  - list:
    - listitem: "[ ] Editor saves content to disk"
    - listitem: "[ ] WebSocket file.changed event fires"
  - complementary:
    ...
    - term: Lineage
    - definition: smoke-req-01
    - term: Parent
    - definition: lifecycle/ideas/smoke-idea-01.md
    - term: Created
    - definition: May 16, 2026
    - term: Modified
    - definition: May 16, 2026
    - group: ▶ Agent Runs 0
    - heading "Relationships" [level=3]
    - text: Outbound CHILD OF
    - link "CHILD OF lifecycle/ideas/smoke-idea-01.md":
      - /url: /p/testproject/artifacts/lifecycle/ideas/smoke-idea-01.md
      - text: lifecycle/ideas/smoke-idea-01.md
    - text: Inbound PARENT OF
    - link "PARENT OF lifecycle/docs/smoke-doc-linked.md":
      - /url: /p/testproject/artifacts/lifecycle/docs/smoke-doc-linked.md
      - text: lifecycle/docs/smoke-doc-linked.md
```
